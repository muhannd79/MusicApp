...
class RockFragment : Fragment(),OnItemClickListener {

    private lateinit var item: ArrayList<ResultLItem>
    private lateinit var adapter: MusicAdapter
    private lateinit var recyclerView :RecyclerView

    private lateinit var ref_layout : SwipeRefreshLayout
    ...
    override fun onCreateView(
       ...
       val  view = inflater.inflate(R.layout.fragment_rock, container, false)
        ...
        recyclerView = view.rv_frag1_rock
        recyclerView.layoutManager=LinearLayoutManager(activity)
        recyclerView.setHasFixedSize(true)


        ref_layout =view.sepRef_rv_list
    ...
    override fun onItemClick(position: Int) {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse(item[position].previewUrl))
